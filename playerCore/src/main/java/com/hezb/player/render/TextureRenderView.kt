 ...
 * File Name:    TextureRenderView
 *
 * Description: TextureView渲染层.
 *
 * @author  hezhubo
 * @date    2022年03月02日 17:33
 */
class TextureRenderView @JvmOverloads constructor(
    ...
    private val mSurfaceTextureListener: SurfaceTextureListener = object : SurfaceTextureListener {
        override fun onSurfaceTextureAvailable(
            ...
            PlayerLog.i("on surface texture available")
        ...
        override fun onSurfaceTextureDestroyed(surface: SurfaceTexture): Boolean {
            PlayerLog.i("on surface texture destroyed")
